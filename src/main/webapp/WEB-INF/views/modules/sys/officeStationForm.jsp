...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/office/stationList">气站列表</a></li>
		<li class="active"><a href="${ctx}/sys/office/stationForm?id=${office.id}&parent.id=${office.parent.id}">气站${not empty office.id?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/stationSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">气站名称:</label>
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="50" class="required"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">气站编码:</label>
			<div class="controls">
