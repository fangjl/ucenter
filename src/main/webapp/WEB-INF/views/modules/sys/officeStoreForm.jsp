...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/sys/office/storeList?id=${office.id}&parent.id=${office.parent.id}">门店${not empty office.id?'修改':'添加'}</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/storeSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
